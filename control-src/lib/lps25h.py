...
class LPS25H(I2C):
    ...
    def getTemperatureFahrenheit(self, rounded = True):
        """ Return the temperature reading in F as a floating point number
            rounded to one decimal place by default.
        """
        celsius = self.getTemperatureCelsius( rounded )
